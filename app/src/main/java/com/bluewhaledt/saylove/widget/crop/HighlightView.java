...
public class HighlightView {
    ...
    private int colorNoFocus = 0xFF000000;
    private int colorFocus = 0xFFFFFFFF;
...
//        mResizeDrawableHeight = resources.getDrawable(R.drawable.gl_camera_crop_height);
        mResizeDrawableDiagonal = resources.getDrawable(R.mipmap.ic_crop_img_indicator);
        mResizeDrawableDiagonal2 = resources.getDrawable(R.mipmap.ic_crop_img_indicator);
        colorFocus = resources.getColor(R.color.colorPrimary);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        Path path = new Path();
        if (!hasFocus()) {
            mOutlinePaint.setColor(colorNoFocus);
...
//                mOutlinePaint.setColor(0xFFEF04D6);
                mOutlinePaint.setColor(colorFocus);
            } else {
