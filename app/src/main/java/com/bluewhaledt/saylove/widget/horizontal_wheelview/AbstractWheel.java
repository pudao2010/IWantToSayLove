...
package com.bluewhaledt.saylove.widget.horizontal_wheelview;
...
import com.bluewhaledt.saylove.widget.horizontal_wheelview.adapters.WheelViewAdapter;
import com.bluewhaledt.saylove.widget.horizontal_wheelview.listener.OnWheelChangedListener;
import com.bluewhaledt.saylove.widget.horizontal_wheelview.listener.OnWheelClickedListener;
import com.bluewhaledt.saylove.widget.horizontal_wheelview.listener.OnWheelScrollListener;
...
public abstract class AbstractWheel extends View {
    ...
    //--------------------------------------------------------------------------
    //
    //  Initiating intentData and assets at start up
    //
    //--------------------------------------------------------------------------

    /**
     * Initiates intentData and parameters from styles
     *
     * @param attrs    a collection of attributes.
     * @param defStyle The default style to apply to this view.
     */
