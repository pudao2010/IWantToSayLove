package com.bluewhaledt.saylove.video_record.audio;
...
public class AudioEncoder {
    ...
    private AudioSoftwareController audioSoftwareController;
    private File outPutFile;

    public AudioEncoder(File outPutFile) {
        this.outPutFile=outPutFile;
        prepare();
    }

    public void setAudioSoftwareController(AudioSoftwareController audioSoftwareController){
        this.audioSoftwareController = audioSoftwareController;
    }
    ...
    private void _offerAudioEncoder(byte[] input, long presentationTimeNs) {
        ...
        try {
            ...
            if (inputBufferIndex >= 0) {
                ...
                if(audioSoftwareController != null){
                    audioSoftwareController.recycleInputBuffer(input);
                }
