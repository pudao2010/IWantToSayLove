 ...
 */
public class AudioSoftwareController {
    ...
    public AudioSoftwareController() {
    }
        ...
        public void run() {
            ...
            while (is_recording) {
                ...
                if (read_result == AudioRecord.ERROR_BAD_VALUE || read_result == AudioRecord.ERROR_INVALID_OPERATION) {
                    EventBus.getDefault().post(new AudioOpenFailEvent(true));
                    is_recording = false;
                } else if (!hasPostEvent) {
                    EventBus.getDefault().post(new AudioOpenFailEvent(false));
                    hasPostEvent = true;
                }
