...
public class MyVisitListModel implements IBaseMode<Visitor> {
    ...
    public void getDataList(Context context, int pageIndex, int pageSize, BaseSubscriber<ZAResponse<ResultEntity<Visitor>>> subscriber) {
        ...
        Observable<ZAResponse<ResultEntity<Visitor>>> observable = service.getMyVisitToList(pageIndex,pageSize);
