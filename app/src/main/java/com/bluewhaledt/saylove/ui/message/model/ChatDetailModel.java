...
public class ChatDetailModel implements IBaseMode<ChatData> {
    ...
    public void setOtherSideInfo(ExtendedData otherInfo) {
        mOtherSideInfo = otherInfo;
    }

    private IMMessage anchor() {
        if (mAnchor == null) {
            return MessageBuilder.createEmptyMessage(mOtherSideInfo.otherSessionId, SessionTypeEnum.P2P, 0);
        } else {
            return mAnchor;
        }
