...
import com.bluewhaledt.saylove.base.widget.picker_view.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public TimePickerView(Context context, Type type) {
        ...
        LayoutInflater.from(context).inflate(R.layout.zhenai_library_pickerview_time, contentContainer);
        // -----确定和取消按钮
