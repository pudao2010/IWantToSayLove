...
public class BaseDialog extends Dialog implements View.OnClickListener,DialogInterface.OnDismissListener {
    ...
    public BaseDialog(Context context) {
        super(context, com.bluewhaledt.saylove.base.R.style.Dialog_Fullscreen);
        mContext = context;
    ...
    private void initView() {
        View child = getLayoutInflater().inflate(R.layout.zhenai_library_dialog_base, null, false);
    ...
    public BaseDialog setListener(DialogInterface.OnClickListener listener){
        mListener = listener;
        return this;
    }
    ...
    public BaseDialog setBtnPanelView(int layoutId, DialogInterface.OnClickListener listener) {
