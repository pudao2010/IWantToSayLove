package com.bluewhaledt.saylove.base.widget.picker_view.lib;
...
import com.bluewhaledt.saylove.base.widget.picker_view.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    private Rect textMeasureRect = new Rect();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                paintCenterText.getTextBounds(contentText, 0, contentText.length(), textMeasureRect);
                int textWidth = textMeasureRect.width();
                if (getMeasuredWidth() > 0 && textWidth >= getMeasuredWidth()) {
                    int length = contentText.length() / 2;
                    contentText = contentText.substring(0, length) + "...";
                }
